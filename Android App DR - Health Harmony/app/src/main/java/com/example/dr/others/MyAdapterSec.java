...
public class MyAdapterSec extends ArrayAdapter<List_data> {
    ArrayList<List_data> listdata;
    Context context;
    int resource;
    public MyAdapterSec(@NonNull Context context, int resource, @NonNull ArrayList<List_data> listdata) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView==null){
            ...
            convertView=layoutInflater.inflate(R.layout.list_item_sec,null,true);
        }
